...
FLASH_Status FLASH_ErasePage(uint32_t Page_Address)
{
  ...
  assert_param(IS_FLASH_ADDRESS(Page_Address));
	...
	clk_change_new();//wsf 20150130 add
  ...
  { 
	...
	clk_reset_old(); //wsf 20150130 add
...
//			*(u16 *)(0x1FFFF802) = 0x1FE;
			for(i=0;i<7;i++)
	  		*(u16 *)(0x1FFFF802+i*2) = 0xFF;
      /* Wait for last operation to be completed */
...
/**
  ...
  * @arg For CC10x Medium-density devices (FLASH page size equal to 1 KB)
  * A value between FLASH_WRProt_Pages0to3 and FLASH_WRProt_Pages124to127
  * @arg For CC10x High-density devices (FLASH page size equal to 2 KB) 
