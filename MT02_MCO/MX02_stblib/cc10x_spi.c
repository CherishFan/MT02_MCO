/**
  ...
  *
  * <h2><center>&copy; COPYRIGHT 2015 MINDMOTION Microelectronics</center></h2>
  */ 
  ...
  switch (*(uint32_t*)&SPIx)
  {
    case SPI1_BASE:
      /* Enable SPI0 reset state */
			...
			//SYSTEM_PeriphResetCmd(SYSTEM_Periph_SPI0, ENABLE);
      /* Release SPI0 from reset state */
      
			//SYSTEM_PeriphResetCmd(SYSTEM_Periph_SPI0, DISABLE);
      break;
