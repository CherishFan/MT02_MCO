...
#include "cc10x.h"	 //wsf modify 2013.10.21
#include "cc10x_dma.h"

#define USB_PRINTF_L0 uart_printf
#define DPRINTF(msg...) uart_printf(msg) //printf("%s:%s:%d:\n",__FILE__,__FUNCTION__,__LINE__);printf(msg);}while(0);
