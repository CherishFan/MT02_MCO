/**
  ...
  *        definitions and memory mapping for CC10x High Density, Medium 
  *        Density and Low Density devices.
  * @author Mindmotion Microelectronics - MCD Application Team
  * @version V1.0.0
  * @date 20/01/2014
  ******************************************************************************
  *
...
/* Uncomment the line below according to the target CC10x device used in your
   application 
  */

//#if !defined (CC10x_LD) && !defined (CC10x_MD) && !defined (CC10x_HD)
#if !defined (MT02) &&  !defined (MF01) && !defined (MZ01)   //wsf modify 20140120
	 //#define MF01           /*!<CM4 devices*/
	 #define MT02           /*!<CM3 devices*/
	 //#define MZ01           /*!<CM0 devices*/
#endif
/*  Tip: To avoid modifying this file each time you need to switch between these
        devices, you can define the device in your toolchain compiler preprocessor.

 - Low-density devices are MZ01, MZ01 microcontrollers
   where the Flash memory density ranges between  64 Kbytes.
 - Medium-density devices are MT01, MT01 microcontrollers
...
/*!< [31:16] CC10x Standard Peripheral Library main version */
#define __CC10x_STDPERIPH_VERSION_MAIN   (0x01)                                  
/*!< [15:8]  CC10x Standard Peripheral Library sub1 version */
#define __CC10x_STDPERIPH_VERSION_SUB1   (0x00)
/*!< [7:0]  CC10x Standard Peripheral Library sub2 version */
#define __CC10x_STDPERIPH_VERSION_SUB2   (0x00) 
/*!< CC10x Standard Peripheral Library version number */
#define __CC10x_STDPERIPH_VERSION       ((__CC10x_STDPERIPH_VERSION_MAIN << 16)\
                                             | (__CC10x_STDPERIPH_VERSION_SUB1 << 8)\
                                             | __CC10x_STDPERIPH_VERSION_SUB2)
 ...
 */
#define __MPU_PRESENT             0 /*!< CC10x does not provide a MPU present or not  */
#define __NVIC_PRIO_BITS          4 /*!< CC10x uses 4 Bits for the Priority Levels    */
...
/******  MT02 CM3 specific Interrupt Numbers *********************************************************/
  ...
  USBWakeUp_IRQn              = 42,     /*!< USB WakeUp from suspend through EXTI Line Interrupt  */
	CPT1_IRQn                   = 43,     /*!< COMPARE1 Interrupt                                   */
  CPT2_IRQn                   = 44,     /*!< COMPARE2 Interrupt                                   */
...
/*!< CC10x Standard Peripheral Library old types (maintained for legacy prupose) */
typedef int32_t  s32;
typedef int16_t s16;
typedef int8_t  s8;
...
typedef struct
{
  __IO uint32_t SAR_LOW;
  __IO uint32_t SAR_HIGH;
  __IO uint32_t DAR_LOW;
  __IO uint32_t DAR_HIGH;
	__IO uint32_t LLP_LOW;
	__IO uint32_t LLP_HIGH;
	__IO uint32_t CTL_LOW;
	__IO uint32_t CTL_HIGH;
	__IO uint32_t SSTAT_LOW;
	__IO uint32_t SSTAT_HIGH;
	__IO uint32_t DSTAT_LOW;
	__IO uint32_t DSTAT_HIGH;
	__IO uint32_t SSTATAR_LOW;
	__IO uint32_t SSTATAR_HIGH;
	__IO uint32_t DSTATAR_LOW;
	__IO uint32_t DSTATAR_HIGH;
	__IO uint32_t CFG_LOW;
	__IO uint32_t CFG_HIGH;
	__IO uint32_t SGR_LOW;
	__IO uint32_t SGR_HIGH;
	__IO uint32_t DSR_LOW;
	__IO uint32_t DSR_HIGH;
} DMA_Channel_TypeDef;

typedef struct
{
  __IO uint32_t RawTf_LOW;       //0x2c0
  __IO uint32_t RawTf_HIGH;      //0x2c4
	__IO uint32_t RawBlock_LOW;    //0x2c8
	__IO uint32_t RawBlock_HIGH;   //0x2cc
	__IO uint32_t RawSrcTran_LOW;  //0x2d0
	__IO uint32_t RawSrcTran_HIGH; //0x2d4
	__IO uint32_t RawDstTran_LOW;//0x2d8
	__IO uint32_t RawDstTran_HIGH;// 0x2dc
	__IO uint32_t RawErr_LOW;////0x2e0
	__IO uint32_t RawErr_HIGH;//0x2e4
	__IO uint32_t StatusTfr_LOW;//0x2e8
	__IO uint32_t StatusTfr_HIGH;//0x2ec
	__IO uint32_t StatusBlock_LOW;//0x2f0
	__IO uint32_t StatusBlock_HIGH;// 0x2f4
	__IO uint32_t StatusSrcTran_LOW;//0x2f8
	__IO uint32_t StatusSrcTran_HIGH;// 0x2fc
	__IO uint32_t StatusDstTran_LOW;// 0x300
	__IO uint32_t StatusDstTran_HIGH;//0x304
	__IO uint32_t StatusErr_LOW;//0x308
	__IO uint32_t StatusErr_HIGH;//0x30c
	__IO uint32_t MaskTfr_LOW;//0x310
	__IO uint32_t MaskTfr_HIGH;//0x314
	__IO uint32_t MaskBlock_LOW;//0x318
	__IO uint32_t MaskBlock_HIGH;//0x31c
	__IO uint32_t MaskSrcTran_LOW;//0x320
	__IO uint32_t MaskSrcTran_HIGH;//0x324
	__IO uint32_t MaskDstTran_LOW;//0x328
	__IO uint32_t MaskDstTran_HIGH;//0x32c
	__IO uint32_t MaskErr_LOW;//0x330
	__IO uint32_t MaskErr_HIGH;//0x334
	__IO uint32_t ClearTfr_LOW;//0x338
	__IO uint32_t ClearTfr_HIGH;// 0x33c
	__IO uint32_t ClearBlock_LOW;//0x340
	__IO uint32_t ClearBlock_HIGH;//0x344
	__IO uint32_t ClearSrcTran_LOW;//0x348
	__IO uint32_t ClearSrcTran_HIGH;//0x34c
	__IO uint32_t ClearDstTran_LOW;//0x350
	__IO uint32_t ClearDstTran_HIGH;//0x354
	__IO uint32_t ClearErr_LOW;//0x358
	__IO uint32_t ClearErr_HIGH;//0x35c
	__IO uint32_t StatusInt_LOW;//0x360
	__IO uint32_t StatusInt_HIGH;//0x364
	__IO uint32_t ReqSrcReg_LOW;//0x368
	__IO uint32_t ReqSrcReg_HIGH;//0x36c
	__IO uint32_t ReqDstReg_LOW;//0x370
	__IO uint32_t ReqDstReg_HIGH;//
	__IO uint32_t SglReqSrcReg_LOW;//
	__IO uint32_t SglReqSrcReg_HIGH;//
	__IO uint32_t SglReqDstReg_LOW;//
	__IO uint32_t SglReqDstReg_HIGH;//
	__IO uint32_t LstSrcReg_LOW;//
	__IO uint32_t LstSrcReg_HIGH;//
	__IO uint32_t LstDstReg_LOW;//
	__IO uint32_t LstDstReg_HIGH;//
	__IO uint32_t DmaCfgReg_LOW;//
	__IO uint32_t DmaCfgReg_HIGH;//
	__IO uint32_t ChEnReg_LOW;//
	__IO uint32_t ChEnReg_HIGH;//
	__IO uint32_t DmaIdReg_LOW;//
	__IO uint32_t DmaIdReg_HIGH;//
	__IO uint32_t DmaTestReg_LOW;//
	__IO uint32_t DmaTestReg_HIGH;//
	__IO uint32_t DMA_COMP_PARAMS_6_LOW;//
	__IO uint32_t DMA_COMP_PARAMS_6_HIGH;//
	__IO uint32_t DMA_COMP_PARAMS_5_LOW;//
	__IO uint32_t DMA_COMP_PARAMS_5_HIGH;//
	__IO uint32_t DMA_COMP_PARAMS_4_LOW;//
	__IO uint32_t DMA_COMP_PARAMS_4_HIGH;//
	__IO uint32_t DMA_COMP_PARAMS_3_LOW;//
	__IO uint32_t DMA_COMP_PARAMS_3_HIGH;//
	__IO uint32_t DMA_COMP_PARAMS_2_LOW;//
	__IO uint32_t DMA_COMP_PARAMS_2_HIGH;//
	__IO uint32_t DMA_COMP_PARAMS_1_LOW;//
	__IO uint32_t DMA_COMP_PARAMS_1_HIGH;//
	__IO uint32_t DMA_Component_ID_Register_LOW;//
	__IO uint32_t DMA_Component_ID_Register_HIGH;//
} DMA_TypeDef;
*/
typedef struct
{
...
/** 
  * @brief IC Sound Peripheral Interface
  */
  typedef struct
{
  __IO uint32_t IER;
...
#define I2S1_BASE             (APB2PERIPH_BASE + 0x4400)
//#define I2S2_BASE             (APB2PERIPH_BASE + 0x4800)
...
#define OPAMP_BASE            (APB2PERIPH_BASE + 0x00003C10)
#define OPAMP1_BASE           (APB2PERIPH_BASE + 0x00003C10)
#define OPAMP2_BASE           (APB2PERIPH_BASE + 0x00003C10)
#define OPAMP3_BASE           (APB2PERIPH_BASE + 0x00003C10)
#define OPAMP4_BASE           (APB2PERIPH_BASE + 0x00003C10)
...
#define  RCC_APB2RSTR_I2S1RST                ((uint32_t)0x00010000)            /*!< I2S1 interface reset */
#define  RCC_APB2RSTR_I2S2RST                ((uint32_t)0x00020000)            /*!< I2S1 interface reset */
...
#define  RCC_APB2ENR_I2S1EN                  ((uint32_t)0x00010000)            /*!< I2S1 clock enable */
#define  RCC_APB2ENR_I2S2EN                  ((uint32_t)0x00020000)            /*!< I2S2 clock enable */
