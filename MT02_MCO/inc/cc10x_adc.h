...
#ifndef __CC10x_ADC_H
#define __CC10x_ADC_H
...
typedef struct
{
  ...
  uint32_t ADC_Mode;
	uint32_t ADC_TRGEN;
  //uint32_t ADC_ExternalTrigConv;    //wsf 20141215 无外部触发，下版本更改
  uint32_t ADC_DataAlign;
}ADC_InitTypeDef;
/**
  * @}
...
#define ADC_Mode_Single                     ((uint32_t)0x00000400) //20141215 wsf modify
#define ADC_Mode_Single_Period              ((uint32_t)0x00000400)
...
/** @defgroup ADC_trigger_enable 
  * @{
  */

#define ADC_TRG_Enable          ((uint32_t)0x00000001)
#define ADC_TRG_Disable         ((uint32_t)0x00000000)
