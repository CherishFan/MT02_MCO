...
#ifndef __CC10x_FLASH_H
#define __CC10x_FLASH_H
...
/* Values to be used with CC10x Medium-density devices: FLASH memory density
...
/* Values to be used with CC10x High-density devices: FLASH memory density
